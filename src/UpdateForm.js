...
const EmployeeUpdate = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.patch(`http://127.0.0.1:8000/employee-detail/${id}/`, employeeData, {
            headers: {
            ...
            >
                ...
                <form onSubmit={handleSubmit} style={{ width: '100%', marginTop: 1 }}>
                    <Grid container spacing={2}>
                        <Grid item xs={6}>
                            <TextField fullWidth type="number" label="ID" value={id} onChange={(e) => setId(e.target.value)} margin="normal" />
                        </Grid>
                        <Grid item xs={6}>
                        ...
                        <Grid item xs={6}>
                            <TextField fullWidth type="text" label="Bank Number" value={bank_name} onChange={(e) => setBank_Name(e.target.value)} margin="normal" />
                        </Grid>
                        <Grid item xs={6}>
